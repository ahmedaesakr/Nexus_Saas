...
export function TriggerNode({ data, selected }: { data: any; selected?: boolean }) {
    return (
        <div
            className={`
        rounded-xl border-2 bg-green-950/20 backdrop-blur-md p-4 min-w-[240px] shadow-lg
        ${selected ? "border-green-400 shadow-green-500/20" : "border-green-500/20"}
        ...
        >
            <div className="flex items-center gap-3 mb-3 border-b border-white/5 pb-2">
                ...
                <div>
                    ...
                    <div className="text-[10px] uppercase tracking-wider text-green-300/70 font-bold">{data.type || "webhook"}</div>
                </div>
            </div>
