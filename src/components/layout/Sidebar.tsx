        ...
        <>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-white/10 shrink-0 bg-[#0c1018]">
                    ...
                    <button
                        onClick={() => setIsMobileOpen(false)}
                        className="md:hidden text-gray-500 hover:text-white focus-visible:ring-2 focus-visible:ring-primary focus:outline-none rounded p-1"
                ...
                <div className="p-4 border-t border-white/10 bg-[#0c1018]">
                    <div
                        className="p-4 rounded-xl bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-white/10 relative overflow-hidden group hover:border-primary/30 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-primary focus:outline-none"
                        role="button"
                        tabIndex={0}
