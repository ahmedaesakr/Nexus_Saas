        ...
        <>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-white/10 shrink-0 bg-[#0c1018]">
                    <Link href="/dashboard" className="flex items-center gap-2 font-bold text-lg text-white group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg p-1 -ml-1">
                    ...
                    <button
                        onClick={() => setIsMobileOpen(false)}
                        className="md:hidden text-gray-500 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded p-1"
                            ...
                            {navigation.slice(0, 4).map((item) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        href={item.href}
                                        className={cn(
                                            "flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 group relative overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                                            isActive
                            ...
                            {navigation.slice(4).map((item) => {
                                ...
                                return (
                                    <Link
                                        ...
                                        href={item.href}
                                        className={cn(
                                            "flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 group relative focus:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                                            isActive
                                                ? "bg-primary text-white shadow-[0_0_20px_rgba(13,89,242,0.3)]"
                                                : "text-gray-400 hover:text-white hover:bg-white/5"
                                        )}
