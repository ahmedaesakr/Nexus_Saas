        ...
        <>
            ...
            >
                ...
                <div className="h-16 flex items-center justify-between px-6 border-b border-white/10 shrink-0 bg-[#0c1018]">
                    <Link href="/dashboard" className="flex items-center gap-2 font-bold text-lg text-white group focus-visible:ring-2 focus-visible:ring-primary focus:outline-none rounded">
                ...
                <div className="p-4 border-t border-white/10 bg-[#0c1018]">
                    <div className="p-4 rounded-xl bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border border-white/10 relative overflow-hidden group hover:border-primary/30 transition-colors cursor-pointer focus-visible:ring-2 focus-visible:ring-primary focus:outline-none" tabIndex={0} role="button" aria-label="Upgrade to Pro Plan" onKeyDown={(e) => {
