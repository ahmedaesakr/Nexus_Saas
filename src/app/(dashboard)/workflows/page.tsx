        ...
        <div className="p-8 container animate-fade-in space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <Link
                    ...
                    className="primary-button btn-tactile px-6 py-3 rounded-xl"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 rounded-[24px] liquid-glass">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {workflows.map((workflow) => (
                    <Link
                        ...
                        className="group relative p-6 liquid-glass rounded-[24px] hover:border-primary/30 transition-all hover:-translate-y-1 cursor-pointer overflow-hidden"
                    >
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-white/5">
                            <div className="flex items-center gap-2">
                                <div className={`w-2 h-2 rounded-full ${workflow.status === "ACTIVE" ? "bg-green-500 animate-pulse" :
                ...
                <Link
                    href="/workflows/builder"
                    className="flex flex-col items-center justify-center p-6 bg-white/4 border border-white/10 border-dashed rounded-[24px] hover:bg-white/8 hover:border-primary/30 transition-all cursor-pointer group h-full min-h-[280px]"
                >
